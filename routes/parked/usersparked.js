...
var sboardroneanchor = "<a href='../../../publicts/index.html' name='sboardone' id='sboardone' style='height: auto; width: 40px; min-height: 0px; background-color: orange; border-radius: 3px/4px; padding: 0px 8px; text-decoration: none; margin-top: 0px; display: inline-block;'>";
...
if(saya === bee) {
	...
	console.log("Error");
	res.send("<div style='text-align: center; color:green;'>Parked Buses Status Updated Successfully!<br/><a href='http://localhost:3000/users/dashboards/componedb' style='text-decoration: none; background-color: lightgrey; padding: 4px; display: inline-block; margin-top: 4px; border-radius: 2px/3px;'>OK</a></div> ");
};
