...
if(saya === bee) {
	...
	console.log("success");
	res.send("<div style='text-align: center; color:green;'>Destiny Buses Status Updated Successfully!<br/><a href='https://travofast.herokuapp.com/usersdg/dashboards/componedbg' style='text-decoration: none; background-color: lightgrey; padding: 4px; display: inline-block; margin-top: 4px; border-radius: 2px/3px;'>OK</a></div> ");
};
