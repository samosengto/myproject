...
function companyName() {
 ...
 function companyNamef() {
  ...
  function companyNameg() {
	document.getElementById('room').value = 'Baby';
	
	
} 
 function companyNameh() {
	document.getElementById('room').value = 'Platinum';
...
function companyNamej() {
 ...
 function companyNamek() {
	document.getElementById('room').value = 'Teso';
 ...
 function companyNamem() {
  ...
  function companyNamen() {
	document.getElementById('room').value = 'Hoima';
...
function companyNameo() {
 ...
 function companyNamep() {
  ...
  function companyNameq() {
	document.getElementById('room').value = 'Arua';
 ...
 function companyNamer() {
  ...
  function companyNames() {
	document.getElementById('room').value = 'Gulu';
...
function companyNamet() {
  ...
  function companyNameu() {
	document.getElementById('room').value = 'Horizon';
	
	
} 
function companyNamev() {
	document.getElementById('room').value = 'Kk';
